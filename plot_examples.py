...
def orn_al_settings(axs):
    ...
    if fig_id=='ts_a':
        ...
        # horizzontal line
        axs[1].plot([2000, 2500], [50, 50], color=black) 
        axs[1].text(2000, 10, '500 ms', color=black, fontsize=scale_fs)
        # vertical line
        axs[1].plot([2000, 2000], [50, 150], color=black) 
        axs[1].text(1600, 40, '100 Hz', color=black,rotation=90, fontsize=scale_fs)
