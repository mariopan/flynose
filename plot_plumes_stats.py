...
ax_wh.legend(fontsize=label_fs-5)
...
ax_wh.text(0.1, .1, panels_id[0], transform=ax_wh.transAxes,
...
ax_bl.text(0.1, .1, panels_id[1], transform=ax_bl.transAxes,
           fontsize=label_fs, fontweight='bold', va='top', ha='right')

if fig_save:
    fig.savefig(fld_stimuli + fig_name+ '_b_c.png')
...
ax_conc.text(0.1, .1, panels_id[2], transform=ax_conc.transAxes,
           fontsize=label_fs, fontweight='bold', va='top', ha='right')
...
if fig_save:
    fig.savefig(fld_stimuli + fig_name + '_d.png')
